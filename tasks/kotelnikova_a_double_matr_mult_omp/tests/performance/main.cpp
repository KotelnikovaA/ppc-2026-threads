...
class KotelnikovaARunPerfTestOMP : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(KotelnikovaARunPerfTestOMP, RunPerfModes) {
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, KotelnikovaATaskOMP>(PPC_SETTINGS_kotelnikova_a_double_matr_mult_omp);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = KotelnikovaARunPerfTestOMP::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultPerfTests, KotelnikovaARunPerfTestOMP, kGtestValues, kPerfTestName);
