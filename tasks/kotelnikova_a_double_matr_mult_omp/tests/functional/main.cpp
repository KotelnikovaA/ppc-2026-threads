...
class KotelnikovaARunFuncTestsOMP : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(KotelnikovaARunFuncTestsOMP, SparseMatrixMultiplication) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<KotelnikovaATaskOMP, InType>(kTestParam, PPC_SETTINGS_kotelnikova_a_double_matr_mult_omp);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = KotelnikovaARunFuncTestsOMP::PrintFuncTestName<KotelnikovaARunFuncTestsOMP>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, KotelnikovaARunFuncTestsOMP, kGtestValues, kPerfTestName);
